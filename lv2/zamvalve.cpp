...
#ifndef FAUSTCLASS 
#define FAUSTCLASS zamvalve
#endif

class zamvalve : public dsp {
  private:
	FAUSTFLOAT 	fslider0;
	FAUSTFLOAT 	fslider1;
  public:
...
#ifndef PLUGIN_URI
#define PLUGIN_URI URI_PREFIX "/zamvalve"
#endif
...
#endif
  if (!plugin_name) plugin_name = "zamvalve";
